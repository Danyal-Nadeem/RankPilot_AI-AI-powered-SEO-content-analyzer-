...
export default function SignupPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground font-sans">
      ...
      {/* Background Orbs */}
      <div className="absolute top-[20%] left-[10%] w-[350px] h-[350px] bg-indigo-500/10 rounded-full blur-[100px] pointer-events-none -z-10 dark:bg-indigo-500/5" />
      <div className="absolute bottom-[20%] right-[10%] w-[350px] h-[350px] bg-purple-500/10 rounded-full blur-[100px] pointer-events-none -z-10 dark:bg-purple-500/5" />
        ...
        <div className="w-full max-w-md">
          <Card className="border-border/80 shadow-2xl bg-card/60 backdrop-blur-md relative overflow-hidden">
            ...
            <CardHeader className="space-y-1.5 text-center">
              ...
              <CardDescription>
                Get started with RankPilot AI today. Free tier includes 5 scans.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.name && (
                    <span className="text-[10px] text-rose-500 font-bold">{errors.name.message}</span>
                  )}
                </div>
            ...
            <CardFooter className="flex flex-col space-y-4 border-t border-border/40 bg-muted/20 py-4 text-center">
              <span className="text-xs text-muted-foreground">
                ...
                <Link href="/login" className="font-bold text-indigo-500 hover:text-indigo-400">
                  Log In
                </Link>
              </span>
